...
# Try to import OpenAI client (works with SambaNova)
try:
...
if not SAMBANOVA_API_KEY:
    st.error("SAMBANOVA_API_KEY not found in .env file!")
    st.info("""
    Please create/update .env file with:
    SAMBANOVA_API_KEY=your_key_from_https://cloud.sambanova.ai/apis
    """)
    st.stop()
